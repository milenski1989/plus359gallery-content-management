...
export const SECTION_SPACING = 5;
export const CONTENT_SPACING = 4;
export const EXTRA_CONTENT_SPACING = 6;
export const SECOND_PAGE_MAX_WIDTH = 128;
export const SECOND_PAGE_VERTICAL_OFFSET = 30;